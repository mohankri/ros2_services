...
static const _Turn_Request_type_support_symbol_names_t _Turn_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, services_quiz_srv, srv, Turn_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, services_quiz_srv, srv, Turn_Request)),
  }
};
...
{
  return &::services_quiz_srv::srv::rosidl_typesupport_cpp::Turn_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, services_quiz_srv, srv, Turn_Request)() {
  return get_message_type_support_handle<services_quiz_srv::srv::Turn_Request>();
}
...
static const _Turn_Response_type_support_symbol_names_t _Turn_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, services_quiz_srv, srv, Turn_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, services_quiz_srv, srv, Turn_Response)),
  }
};
...
{
  return &::services_quiz_srv::srv::rosidl_typesupport_cpp::Turn_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, services_quiz_srv, srv, Turn_Response)() {
  return get_message_type_support_handle<services_quiz_srv::srv::Turn_Response>();
}
...
static const _Turn_type_support_symbol_names_t _Turn_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, services_quiz_srv, srv, Turn)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, services_quiz_srv, srv, Turn)),
  }
};
...
{
  return &::services_quiz_srv::srv::rosidl_typesupport_cpp::Turn_service_type_support_handle;
}
