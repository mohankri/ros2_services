...
bool services_quiz_srv__srv__turn__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("services_quiz_srv.srv._turn.Turn_Request", full_classname_dest, 40) == 0);
  }
  services_quiz_srv__srv__Turn_Request * ros_message = _ros_message;
  {  // direction
...
PyObject * services_quiz_srv__srv__turn__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("services_quiz_srv.srv._turn");
...
ROSIDL_GENERATOR_C_EXPORT
bool services_quiz_srv__srv__turn__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("services_quiz_srv.srv._turn.Turn_Response", full_classname_dest, 41) == 0);
  }
  services_quiz_srv__srv__Turn_Response * ros_message = _ros_message;
  {  // success
