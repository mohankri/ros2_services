...
: ${AMENT_CURRENT_PREFIX:="/home/user/ros2_ws/src/install/services_quiz"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/services_quiz/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/services_quiz/environment/path.sh"
