...
: ${AMENT_CURRENT_PREFIX:="/home/user/ros2_ws/src/install/mars_rover_tasks"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mars_rover_tasks/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mars_rover_tasks/environment/path.sh"
